...
import { useSignIn } from "@/lib/useAuthentication"
            ...
            <div className="min-h-screen flex items-center justify-center p-4">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-600">Sign in to continue to SEA Catering</p>
                    </div>
                        ...
                        <CardContent>
                            <form autoComplete="off" className="space-y-6" onSubmit={formik.handleSubmit} >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link to="/signup" className="text-sm text-emerald-600 hover:text-emerald-700 font-medium">
                                        Sign Up
                                    </Link>
                                </div>
